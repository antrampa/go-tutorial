...
func main() {
	...
	src, dist := "F:\\GoWork\\src\\go-tutorial\\src\\main\\apisync\\prod\\mvngt-prod.bat", "R:\\Projects\\MedSuiteGit\\MedSuiteApiSync\\src\\MedSuiteApiSync\\medhistory\\mvngt.bat"
	...
	srcdb, distdb := "F:\\GoWork\\src\\go-tutorial\\src\\main\\apisync\\prod\\MedExpress.sdf", "C:\\Users\\Antonis\\AppData\\Roaming\\MedExpress\\db\\MedExpress.sdf"
	fmt.Printf("Copying %s to %s\n", srcdb, distdb)
	//err := CopyFile(os.Args[1], os.Args[2])
